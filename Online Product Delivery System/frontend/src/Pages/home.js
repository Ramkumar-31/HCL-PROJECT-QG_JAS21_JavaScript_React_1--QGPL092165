            ...
            <Container>
                ...
                <Grid container justify="space-around" alignItems="center" direction="column" >
                        ...
                        <Grid xs={12} sm={6} item>
                            <Typography variant="h3" align="center" className={classes.heading} >Welcome To Online Products</Typography>
                            <Typography variant="subtitle1" align="middle" color="textSecondary" gutterBottom={true} >Shop for the new trends at never seen prices</Typography>
                        </Grid>
                ...
                <Grid container justify="center" alignItems="center" style={{marginTop:"3em"}} >
                    ...
                    <Grid xs={12} sm={2} item>
                        <Typography variant="h4" color="secondary">LATEST FASHION ITEMS</Typography>
                    </Grid>
